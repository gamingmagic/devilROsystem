...
----------------------------------------------------------
function add_url()
	local M = "<URL>[ Devil RO]<INFO>https://playdevilro.com/</INFO></URL>"
	return M
end
function add_item_link(v)
	local M = "<URL>ItemID:" .. tostring(v) .. " <INFO>https://playdevilro.com/item/view/?id=" .. tostring(v) .. "</INFO></URL>"
	-- FOR FluxCP
	--local M = "<URL>ItemID:[" .. tostring(v) .. "](Click Me!)<INFO>https://playdevilro.com/item/view/?id=" .. tostring(v) .. "</INFO></URL>"
	return M
end
function main()
	IInfo = {"System.itemInfo_trans_main","System.itemInfo_true","System.itemInfo_re"}
	-- Example!
