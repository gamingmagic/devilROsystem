...
----------------------------------------------------------
function add_url()
	local M = "<URL>[ Devil RO]<INFO>https://streamsidero.com/</INFO></URL>"
	return M
end
function add_item_link(v)
	local M = "<URL>ItemID:" .. tostring(v) .. " <INFO>https://streamsidero.com/item/view/?id=" .. tostring(v) .. "</INFO></URL>"
	-- FOR FluxCP
	--local M = "<URL>ItemID:[" .. tostring(v) .. "](Click Me!)<INFO>https://streamsidero.com/item/view/?id=" .. tostring(v) .. "</INFO></URL>"
	return M
end
function main()
	IInfo = {"System.itemInfo_Stream_main","System.itemInfo_true","System.itemInfo_re"}
	-- Example!
